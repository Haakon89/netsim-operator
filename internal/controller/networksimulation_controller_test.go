...
var _ = Describe("NetworkSimulation Controller", func() {
	Context("When reconciling a resource", func() {
		...
		networksimulation := &simv1alpha1.NetworkSimulation{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind NetworkSimulation")
			err := k8sClient.Get(ctx, typeNamespacedName, networksimulation)
