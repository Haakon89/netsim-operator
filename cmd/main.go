...
import (
	...
	"github.com/Haakon89/netsim-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4bbfc8a9.example.local",
	...
	if err := (&controller.NetworkSimulationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "NetworkSimulation")
		os.Exit(1)
	}
